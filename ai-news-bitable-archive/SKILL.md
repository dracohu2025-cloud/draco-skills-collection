...
description: Use when parsing a DingTalk daily news document and syncing title, date, Top 3, summary, conclusion, document link, and status into a DingTalk multidimensional table.
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
  hermes:
    ...
    - cron
---
# AI News → DingTalk Multidimensional Table Archive
...
When the task runs on DingTalk instead of Feishu/Lark, use the DingTalk-native script and commands below. The parsed fields logic remains unchanged.
